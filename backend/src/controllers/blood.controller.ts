...
//     // Check if user owns the request - FIXED
...
//       .select('name email phone bloodGroup location avatar')
//       .limit(50);
...
//         donorAvailable: req.body.available || true,
//       },
//       { new: true }
//     );
...
//       donorAvailable: true,
//       'location.province': bloodRequest.location.province,
//     })
